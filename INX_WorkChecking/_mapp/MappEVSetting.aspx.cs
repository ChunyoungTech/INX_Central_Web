...
select A.ID,A.Code,A.Name,A.IsTop,B.MS_SYS_DESC as NormalCode,C.MS_SYS_DESC as DisableCode
...
left join MappSetting C on A.DisableID=C.MS_SEQ_ID where 1=1 {0} {1}"
