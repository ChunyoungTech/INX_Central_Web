<%@ Page Title="" Language="C#" MasterPageFile="~/_master/Edit.Master" AutoEventWireup="true" CodeBehind="WorkCkeckList.aspx.cs" Inherits="WebApp._edit.WorkCkeckList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <style type="text/css">
        .GridYellow tr:nth-child(odd) td{background-color:transparent;}
    </style>
</asp:Content>
...
<asp:Content ID="Content4" ContentPlaceHolderID="TabContent" runat="server">
    ...
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="MainGridView Grid100 GridYellow"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Supplier" HeaderText="廠商" HeaderStyle-Width="20em" />
            <asp:BoundField DataField="Date" HeaderText="哨口入廠時間" DataFormatString="{0:yyyy/MM/dd HH:mm}" HeaderStyle-Width="9em" />
        </Columns>
        <PagerTemplate>
        </PagerTemplate>
        <EmptyDataTemplate>
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="false" CssClass="MainGridView Grid100"
        ...
        <Columns>
            <asp:BoundField DataField="Name" HeaderText="姓名" />
            <asp:BoundField DataField="Supplier" HeaderText="廠商" HeaderStyle-Width="20em" />
            <asp:BoundField DataField="Date" HeaderText="廠務報到時間" DataFormatString="{0:yyyy/MM/dd HH:mm}" HeaderStyle-Width="9em" />
        </Columns>
        <PagerTemplate>
        </PagerTemplate>
        <EmptyDataTemplate>
    ...
    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="false" CssClass="MainGridView Grid100"
        ...
        <Columns>
            <asp:BoundField DataField="Name" HeaderText="姓名" />
            <asp:BoundField DataField="Supplier" HeaderText="廠商" HeaderStyle-Width="20em" />
            <asp:BoundField DataField="Date" HeaderText="廠務報退時間" DataFormatString="{0:yyyy/MM/dd HH:mm}" HeaderStyle-Width="9em" />
        </Columns>
        <PagerTemplate>
        </PagerTemplate>
        <EmptyDataTemplate>
    ...
    <asp:GridView ID="GridView4" runat="server" AutoGenerateColumns="false" CssClass="MainGridView Grid100 GridYellow"
        ...
        <Columns>
            <asp:BoundField DataField="Name" HeaderText="姓名" />
            <asp:BoundField DataField="Supplier" HeaderText="廠商" HeaderStyle-Width="20em" />
            <asp:BoundField DataField="Date" HeaderText="哨口離廠時間" DataFormatString="{0:yyyy/MM/dd HH:mm}" HeaderStyle-Width="9em" />
        </Columns>
        <PagerTemplate>
        </PagerTemplate>
        <EmptyDataTemplate>
