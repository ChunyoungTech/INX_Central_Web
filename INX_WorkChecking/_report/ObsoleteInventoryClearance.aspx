<%@ Page Title="" Language="C#" MasterPageFile="~/_master/Grid.master" AutoEventWireup="true" CodeBehind="ObsoleteInventoryClearance.aspx.cs" Inherits="WebApp._report.ObsoleteInventoryClearance" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="QueryArea">
    <h3 style="padding-left: 1em;">備堪品去化</h3>
        <ul>
            <li style="display: none;">類別：<asp:DropDownList ID="ddlLevel01" runat="server"></asp:DropDownList>
