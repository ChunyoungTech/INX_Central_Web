<%@ Page Title="" Language="C#" MasterPageFile="~/_master/Grid.master" AutoEventWireup="true" CodeBehind="OvertimeHoursStatistics.aspx.cs" Inherits="WebApp._report.OvertimeHoursStatistics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="QueryArea">
        <h3 style="padding-left:1em;">加班時數統計</h3>
        <ul>
            <li>
            ...
            <ContentTemplate>
                ...
                <%--<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="MainGridView" PagerSettings-Visible="false"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Level01" HeaderText="" />
