<%@ Page Title="" Language="C#" MasterPageFile="~/_master/Grid.master" AutoEventWireup="true" CodeBehind="TurnoverRateStatistics.aspx.cs" Inherits="WebApp._report.TurnoverRateStatistics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="QueryArea">
        <h3 style="padding-left:1em;">離職率統計</h3>
        <ul>
            <li>
