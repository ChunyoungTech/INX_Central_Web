<%@ Page Title="" Language="C#" MasterPageFile="~/_master/Grid.master" AutoEventWireup="true" CodeBehind="AlarmStatistics.aspx.cs" Inherits="WebApp._report.AlarmStatistics" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="QueryArea">
        <h3 style="padding-left:1em;">警報統計</h3>
        <ul>
            <li style="display:none;">
                類別：<asp:DropDownList ID="ddlLevel01" runat="server"></asp:DropDownList>
            </li>
            <li>
                ...
                <%--<asp:DataList ID="DataList1" runat="server" Width="99%">
                    <ItemTemplate>
                        <div style="color:red; font-weight:600; padding-top: .3em;">
                            <asp:Label ID="Label1" runat="server" Text='<%#Eval("Level01") %>'></asp:Label>
                            <asp:Label ID="Label2" runat="server" Text='<%#Eval("Level02") %>'></asp:Label>
                        </div>
