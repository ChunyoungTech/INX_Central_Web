<%@ Page Title="" Language="C#" MasterPageFile="~/_master/Grid.master" AutoEventWireup="true" CodeBehind="WorkCheckMappSetting.aspx.cs" Inherits="WebApp._app.WorkCheckMappSetting" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        var extOpt = [{ reCtl: "#<%=btnQuery.ClientID%>", Width: .6, Sub: "21" }];
        InitExt(extOpt);
    </script>
</asp:Content>
...
<%--                <asp:LinkButton ID="lbRefresh" runat="server" />
                ...
                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="MainGridView Grid100"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="DeptName" HeaderText="發送部門" SortExpression="DeptName" />
