<%@ Page Title="" Language="C#" MasterPageFile="~/_master/Grid.master" AutoEventWireup="true" CodeBehind="MappEVSetting.aspx.cs" Inherits="WebApp._app.MappEVSetting" %>
                ...
                <div class="fix-table">
                    <asp:GridView ID="GridView1" runat="server" CssClass="MainGridView Grid100" AutoGenerateColumns="False" AllowSorting="true" AllowPaging="true"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="NormalCode" HeaderText="MAPP發送設定" />
                            <%--<asp:BoundField DataField="DisableCode" HeaderText="隔離發送設定" />--%>
                            <asp:TemplateField HeaderText="CIM<br/>發送" ItemStyle-HorizontalAlign="Center" SortExpression="CimEnable">
                                <ItemTemplate>
                                    <uc:YesNo ID="ucYesNo2" Value='<%#Eval("CimEnable") %>' runat="server" />
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:BoundField DataField="CimLevel" HeaderText="CIM<br/>比重" ItemStyle-HorizontalAlign="Center" HtmlEncode="false" />
                            <asp:BoundField DataField="CimGroup" HeaderText="CIM<br/>分組" ItemStyle-HorizontalAlign="Center" HtmlEncode="false" />
<%--                            <asp:TemplateField ItemStyle-HorizontalAlign="Center" HeaderStyle-Width="3em">
                                <ItemTemplate>
                                    <input type="button" class="extBtn" value="加發設定" data-val='<%#Eval("ID") %>' data-idx="1" data-height=".9" />
                                </ItemTemplate>
                            </asp:TemplateField>--%>
                        </Columns>
                        <EmptyDataTemplate>
