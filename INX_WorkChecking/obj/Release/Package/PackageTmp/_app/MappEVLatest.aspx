<%@ Page Title="" Language="C#" MasterPageFile="~/_master/Grid.master" AutoEventWireup="true" CodeBehind="MappEVLatest.aspx.cs" Inherits="WebApp._app.MappEVLatest" %>
...
<%--        var extOpt = [
        ...
        $(function () {
            ...
            $(document).on("change", ".pTime", function () {
                if ($(this).val() == "") {
                    $(this).val("00:00:00");
                }
            });
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="true">
            <ContentTemplate>
                <div style="padding:0.2em;margin:0.2em;">
                    資料來源：
                    <asp:TextBox ID="txtSource" runat="server" Text="Manual"></asp:TextBox>
                ...
                <asp:GridView ID="GridView1" runat="server" CssClass="MainGridView" AutoGenerateColumns="false" AllowSorting="false" AllowPaging="false"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="觸發日期" HeaderStyle-Width="8em">
                            <ItemTemplate>
                                <asp:TextBox ID="txtDate" runat="server" Text='<%#Eval("DateStr") %>' CssClass="cycDate pDate" ></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="觸發時間" HeaderStyle-Width="8em">
                            <ItemTemplate>
                                <asp:TextBox ID="txtTime" runat="server" Text='<%#Eval("TimeStr") %>' CssClass="pTime"></asp:TextBox>
                            </ItemTemplate>
                        </asp:TemplateField>
                ...
                <asp:Panel ID="Panel1" runat="server" style="padding:0.2em;margin:0.2em;">
                    MAPP訊息預覽：<br />
