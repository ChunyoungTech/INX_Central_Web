<%@ Page Title="" Language="C#" MasterPageFile="~/_master/Grid.master" AutoEventWireup="true" CodeBehind="FactoryExpenseAnalysis.aspx.cs" Inherits="WebApp._report.FactoryExpenseAnalysis" %>
...
<%--                <asp:LinkButton ID="lbRefresh" runat="server" />
                ...
                <%--<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="MainGridView" PagerSettings-Visible="false"
                    GridLines="Both" AllowSorting="true" AllowPaging="false" ShowHeaderWhenEmpty="true" OnRowDataBound="GridView1_RowDataBound">
                    <Columns>
                        <asp:BoundField DataField="FAC" HeaderText="廠別" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="5em" />
                        <asp:BoundField DataField="Level01" HeaderText="主類別" />
                        <asp:BoundField DataField="Level02" HeaderText="次類別" />
