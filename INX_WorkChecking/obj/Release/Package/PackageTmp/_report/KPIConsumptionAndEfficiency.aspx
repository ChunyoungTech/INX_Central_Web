<%@ Page Title="" Language="C#" MasterPageFile="~/_master/Grid.master" AutoEventWireup="true" CodeBehind="KPIConsumptionAndEfficiency.aspx.cs" Inherits="WebApp._report.KPIConsumptionAndEfficiency" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="QueryArea">
        <h3 style="padding-left:1em;">KPI耗量與效率</h3>
        <ul>
            <li>
...
<%--                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" CssClass="MainGridView" PagerSettings-Visible="false"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="Level02" HeaderText="" />
